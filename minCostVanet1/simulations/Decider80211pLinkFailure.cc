...
simtime_t Decider80211pLinkFailure::processNewSignal(AirFrame* msg) {
...
int Decider80211pLinkFailure::getSignalState(AirFrame* frame) {
...
double Decider80211pLinkFailure::calcChannelSenseRSSI(simtime_t_cref start, simtime_t_cref end) {
...
void Decider80211pLinkFailure::calculateSinrAndSnrMapping(AirFrame* frame, Mapping **sinrMap, Mapping **snrMap) {
...
Mapping* Decider80211pLinkFailure::calculateNoiseRSSIMapping(simtime_t_cref start, simtime_t_cref end, AirFrame *exclude) {
...
DeciderResult* Decider80211pLinkFailure::checkIfSignalOk(AirFrame* frame) {
...
void Decider80211pLinkFailure::GetProbabilityOfNoErrorInRestOfPacket(int packetOkSinr){

}

enum Decider80211pLinkFailure::PACKET_OK_RESULT Decider80211pLinkFailure::packetOk(double snirMin, double snrMin, int lengthMPDU, double bitrate) {
...
bool Decider80211pLinkFailure::cca(simtime_t_cref time, AirFrame* exclude) {
...
simtime_t Decider80211pLinkFailure::processSignalEnd(AirFrame* msg) {
...
void Decider80211pLinkFailure::setChannelIdleStatus(bool isIdle) {
...
void Decider80211pLinkFailure::changeFrequency(double freq) {
    centerFrequency = freq;
}

void Decider80211pLinkFailure::finish() {
...
Decider80211pLinkFailure::~Decider80211pLinkFailure() {}
;
