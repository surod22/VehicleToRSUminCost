...
#ifndef DECIDER80211pLINKFAILURE_H_
#define DECIDER80211pLINKFAILURE_H_
 ...
 */
class Decider80211pLinkFailure: public BaseDecider {
    public:
    ...
    protected:
        ...
        std::string myPath;
        Decider80211pLinkFailureToPhy80211pInterface* phy11p;
    ...
    public:
         ...
         */
        Decider80211pLinkFailure(DeciderToPhyInterface* phy,
                      double sensitivity,
                      double centerFrequency,
                      int myIndex = -1,
        ...
        void GetProbabilityOfNoErrorInRestOfPacket(int packetOkSinr);

        bool cca(simtime_t_cref, AirFrame*);
        int getSignalState(AirFrame* frame);
        virtual ~Decider80211pLinkFailure();
